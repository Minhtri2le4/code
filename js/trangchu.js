window.onload = function () {
	...
	var company = ["Macbook.jpg", "Macbook99.jpg", "Apple.jpg", "Ipad.jpg", "Imac.jpg", "Sunface.jpg",
		"Jcpal.jpg", "Mocol.jpg", "HUB.jpg", "Chuot.jpg", "Key.jpg", "Mouse.jpg", "Simtop.jpg", "Capsac.jpg"
	];
	...
	if (filters.length) { // có filter
		...
		addKhungSanPham('DANH SÁCH SẢN PHẨM', yellow_red, ['star=3', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('MACBOOK', blue, ['promo=Macbook', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('MACBOOK 99%', yellow_red, ['promo=Macbook99', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('IPHONE', green, ['promo=Iphone', 'sort=rateCount-decrease'], soLuong, div);
		addKhungSanPham('IPAD', yellow_red, ['promo=Ipad'], soLuong, div);
		addKhungSanPham('SẢN PHẨM MỚI NHẤT', green, ['price=0-3000000', 'sort=price'], soLuong, div);
	}
	...
	addPromotion('MACBOOK');
	addPromotion('MACBOOK 99%');
	addPromotion('IPHONE');
	addPromotion('IPAD');
