...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["Apple", "Macbook", "Mb99", "Ipad", "Imac", "Sunface", "Jcpal", "Mocol", "HUB", "Chuot", "Key", "Mouse", "Simtop", "Capsac", "Minimac"];
        ...
        <tr>
            ...
            <td>
                <select>
                    ...
                    <option value=" Macbook" ` + (sp.promo.name == 'Macbook' ? 'selected' : '') + `>Macbook</option>
                    <option value="Macbook99" ` + (sp.promo.name == 'Macbook99' ? 'selected' : '') + `>Macbook99</option>
                    <option value="Iphone" ` + (sp.promo.name == 'Iphone' ? 'selected' : '') + `>Iphone</option>
                    <option value="Ipad" ` + (sp.promo.name == 'Ipad' ? 'selected' : '') + `>Ipad</option>
                </select>
            </td>
        </tr>
        <tr>
