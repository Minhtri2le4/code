	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <a href="https://www.facebook.com/profile.php?id=61551619441915&locale=vi_VN" class="fa fa-facebook"></a>
                <a href="https://www.tiktok.com/@saigonmacbook">TIKTOK</a>
                <a href="https://www.youtube.com/@saigonmacbook/shorts" class="fa fa-youtube"></a>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.jpg" alt="Trang chủ Macbook sài gòn" title="Trang chủ Macbook sài gòn">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">MACBOOK Sài Gòn</a> - UY TÍN - CHẤT LƯỢNG 
            ...
            <div class="tab-content">
                <div id="login">
                    ...
                    <form onsubmit="return logIn(this);">
                        ...
                        <div class="field-wrap">
                            <label>
                                Tên đăng nhập (Số điện thoại của bạn) <span class="req">*</span>
                            </label>
                ...
                <div id="signup">
                    ...
                    <form onsubmit="return signUp(this);">
                        ...
                        <div class="field-wrap">
                            <label>
                                Tên đăng nhập (Nhập Số Điện Thoại Của Bạn) <span class="req">*</span>
                            </label>
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ
                    <br>Hotline:
                    <a href="tel:12345678" style="color: #288ad6;">0901633211</a>
                </li>
            </ul>
        </section>
    </div>`);
